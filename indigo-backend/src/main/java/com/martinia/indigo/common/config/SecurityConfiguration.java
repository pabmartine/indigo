	...
	public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authManager) throws Exception {
		http
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers(HttpMethod.GET, "/api/book/sent").authenticated()
						.requestMatchers(HttpMethod.GET, "/api/book/recommendations/user").authenticated()
						.requestMatchers(HttpMethod.GET, "/api/book/recommendations/user/count").authenticated()
