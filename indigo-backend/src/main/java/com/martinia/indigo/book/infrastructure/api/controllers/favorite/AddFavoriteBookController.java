...
public class AddFavoriteBookController {
	...
	@Operation(summary = "Add a book to favorites",
			description = "Adds a specified book to a user's list of favorite books.",
			responses = {
					@ApiResponse(responseCode = "200", description = "Book successfully added to favorites"),
	...
	public ResponseEntity<Void> addFavoriteBook(
			@Parameter(description = "The ID of the book to add to favorites", example = "60c72b2f9b1e8c001c8e4a0a") @RequestParam String book,
			@Parameter(description = "The username of the user adding the favorite book", example = "john.doe") @RequestParam String user) {
