...
class FindBookByPathControllerIntegrationTest extends BaseIndigoIntegrationTest {
	...
	void testGetBookByPath() throws Exception {
		...
		// When
		ResultActions result = mockMvc.perform(MockMvcRequestBuilders.get("/api/book/path").param("path", bookMongoEntity.getPath()));
		// Then
	...
	@Test
	void testGetBookByPathNotFound() throws Exception {
		// Given
