...
import com.martinia.indigo.notification.infrastructure.api.controllers.FindAllNotificationsByUserController;
...
public class FindAllNotificationsByUserControllerTest extends BaseIndigoTest {

	@InjectMocks
	private FindAllNotificationsByUserController findAllNotificationsByUserController;
	...
	@Test
	public void findAllByUser_ValidUser_ReturnsListOfNotificationDtos() throws Exception {
		// Given
		String user = "john";
		...
		when(findAllNotificationsByUserUseCase.findByUser(user))
		...
		// When
		mockMvc.perform(get("/api/notification/user")
						.param("user", user)
